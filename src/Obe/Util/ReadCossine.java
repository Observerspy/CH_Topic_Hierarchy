...
public class ReadCossine {
	
	private static ReadCossine r = null;
...
//		String[] text = f.returnS().split("###");
		...
		l.setPath(GetPropertiesUtils.getoutPutDir()+"/CosSimOfTotal.txt");
		String ss = "";
		try {
			ss = l.Load();
		} catch (Exception e) {
		...
		System.out.println("cossine load finished!");
...
//		}
	...
	public static ReadCossine getNew() {
		if(r==null)
			r = new ReadCossine();
		return r;
	}
